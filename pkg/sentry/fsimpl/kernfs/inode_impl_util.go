...
func (InodeAttrsReadonly) SetStat(ctx context.Context, fs *vfs.Filesystem, opts vfs.SetStatOptions) error {
...
// SetStat implements Inode.SetStat.
func (a *InodeAttrs) SetStat(ctx context.Context, fs *vfs.Filesystem, opts vfs.SetStatOptions) error {
	if opts.Stat.Mask == 0 {
		return nil
	}
